...
//             gridheight: "1040,768,650,450",
//             lazyType: "smart",
//             perspective: 600,
//             perspectiveType: "global",
//             editorheight: "1040,768,650,450",
...
RS_MODULES.modules["revslider31"] = {
    ...
    init: function () {
        window.revapi3 = window.revapi3 === undefined || window.revapi3 === null || window.revapi3.length === 0
        ...
        revapi3.revolutionInit({
            ...
            visibilityLevels: "1240,1024,778,480",
            gridwidth: "1300,1024,778,480",
            gridheight: "1000,800,600,500", // Use height as per your images
            lazyType: "smart",
            perspective: 600,
            perspectiveType: "global",
            editorheight: "1000,800,600,500",
            responsiveLevels: "1240,1024,778,480",
            progressBar: { disableProgressBar: true },
            navigation: {
                wheelCallDelay: 1000,
                ...
                arrows: {
                    ...
                    animSpeed: "100ms",
                    animDelay: "100ms",
                    left: { h_offset: 30, v_offset: 60 },
                    right: { h_offset: 30, v_offset: 60 }
                },
                bullets: {
                    enable: true,
                    tmp: "",
...
RS_MODULES.modules["revslider51"] = {
    once: RS_MODULES.modules["revslider51"] !== undefined ? RS_MODULES.modules["revslider51"].once : undefined, init: function () {
        ...
        revapi5.revolutionInit({
            ...
            visibilityLevels: "1240,1024,778,480",
            gridwidth: "1300,1024,778,480",
            gridheight: "900,768,550,450",
            lazyType: "smart",
            perspective: 600,
            perspectiveType: "global",
            editorheight: "900,768,550,450",
            responsiveLevels: "1240,1024,778,480",
            progressBar: { disableProgressBar: true },
            navigation: {
                wheelCallDelay: 1000,
